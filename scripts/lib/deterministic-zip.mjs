...
// Verbatim mirror of MailPoppy's node-sidecar/scripts/lib/deterministic-zip.mjs — directory packages must be byte-reproducible, which is why STORE + fixed mtimes matter.
